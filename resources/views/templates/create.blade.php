...
<div class="container ">
    <div class="card">
        <div class="card-header">
            <h1 class="card-title">Add New Template</h1>
        </div>
        <div class="card-body">
            <form action="{{ route('templates.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="templateDetails" name="details" placeholder="Enter template details" required></textarea>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="templateImage" name="image" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="templateZip" name="zip" required>
